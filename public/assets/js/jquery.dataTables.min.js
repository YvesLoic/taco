...
!function (n) {
    ...
    var p, e, t, C = function (t, v) {
            ...
            return this.each(function () {
                var r = 1 < _ ? be({}, v, !0) : v, o = 0, t = this.getAttribute("id"), i = !1, e = C.defaults, l = P(this);
    ...
    var Ot = C.util.escapeRegex, Mt = P("<div>")[0], kt = Mt.textContent !== N;
    ...
    function zt(t) {
        ...
        var e = t.sPaginationType, f = C.ext.pager[e], d = "function" == typeof f,
    ...
    function Qt(n) {
        ...
        var e, a, r, o, i, l = n.oScroll, s = l.sX, u = l.sXInner, c = l.sY, l = l.iBarWidth, f = P(n.nScrollHead),
            ...
            D = P(n.nTable), _ = D[0], C = _.style, w = n.nTFoot ? P(n.nTFoot) : null, T = n.oBrowser,
    ...
    function ee(t) {
        ...
        if (g || !h && !l && !i && s == T(t) && s == c.length) for (D = 0; D < s; D++) {
            ...
            for (var v = P("<div/>").css(l || i ? {
                ...
                var _ = P(c[D]), C = _.outerWidth() - _.width(),
    ...
    function ge(t) {
        var e = C.settings, t = P.inArray(t, H(e, "nTable"));
        return -1 !== t ? e[t] : null
    }
    ...
    function ve(t, e) {
        var t = t.renderer, n = C.ext.renderer[e];
    ...
    var Ie = [], o = Array.prototype, B = function (t, e) {
        ...
        var n = new B(e), a = "on-plugin-init";
        const r = "stateSaveParams." + a, o = "destroy." + a;
        ...
        var t = !1, n = (P.isPlainObject(e) && (t = e.api, e = e.visible), P.map(C.settings, function (t) {
